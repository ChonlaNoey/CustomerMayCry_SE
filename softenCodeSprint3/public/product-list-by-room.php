    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                        ...
                        if($total_row > 0)
                        {
                            ...
                            ?>
                                ...
                                <td width="250px"><div name="btn-group" method="POST">
                                    <a href="edit-equipment.php?equipment_id=<?php echo $row['equipment_id'];?>" class="btn btn-dark" id="btn-edit<?php echo $i;?>" name="btn-edit<?php echo $i;?>">แก้ไข</a>   
                                    <a href="delete-equipment.php?equipment_id=<?php echo $row['equipment_id'];?>" class="btn btn-dark" id="btn-delete<?php echo $i;?>" name="btn-delete<?php echo $i;?>">ลบข้อมูล</a>
                                </div></td>
                                </tr>
                            <?php
                            }
                ...
                <a href="admin_list.php" class="btn btn-dark" id="btn-back" name="btn-back" >ย้อนกลับ</a>
                </div>
            </div>
            </div>
