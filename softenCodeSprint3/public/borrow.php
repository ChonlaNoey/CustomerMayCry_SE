...
<?php   
  ...
  if($_SESSION["role"] == "Staff"){
    ...
    if (isset($_POST['btn-submit'])) {    
        ...
        if($reason!='' && $dateToBorrow!='' && $dateToBringback!='' && $quantityToBorrow!=''){
          $alert = 'ส่งคำร้องขอยืมครุภัฑณ์สำเร็จ';
        }
        if($alert != ""){
      ...
      <div style="width: 1000px; height:auto; margin-top:50px;">
        <div class="card">
            ...
            <br><br>
                ...
                <button type="submit" name="btn-submit" id="btn-submit" class="btn btn-dark">ส่งคำร้องขอยืม</button>
            </form>
            </div>
            </div>
        <div>
