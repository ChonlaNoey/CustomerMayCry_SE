<?php 
  ...
  if($_SESSION["role"] == "Staff"){
	...
	if (isset($_POST['btn-submit'])) {    
        $equipment_id = $_GET['equipment_id'];
        $location = $equip['locationID'];
        $category = $equip['categoryID'];
		...
		header("location: product-list-by-room.php?cid=$category&lid=$location");
    }
  ...
  <body data-gr-c-s-loaded="true">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">ลบครุภัณฑ์หมายเลข - <?php echo $equipment_id;?></h1>
        </div>
            ...
            <div class="col-sm-12">
                ...
                <form method="post" style="margin-top:20Px;"><center>
					<table>
						...
						<td><a name="equipName_th" id="equipName_th" value="<?php echo $equip['equipName_th'];?>"><?php echo $equip['equipName_th'];?><a></td>
                        </tr>
						<tr>
						...
						<td><a name="category" id="category" value="<?php echo $equip['categoryID'];?>"><?php echo $equip['categoryName_th'];?></a></td>
						</tr>
						<tr>
                        ...
                        <td><a name="location" id="location" value="<?php echo $equip['locationID'];?>"><?php echo $equip['locationName_th'];?></a></td>
						</tr>
						<tr>
						<td><label ><b>สถานะ : </b></label></td>
                        <td><?php echo $equip['status_th'];?></td>
						</tr>
						<tr>
						<td colspan=2><label><b>รายละเอียดครุภัณฑ์ : </b></label></td></tr>
						<tr><td colspan=2><textarea readonly name="detail" name="detail" rows = 5 cols=50 ><?php echo $equip['equipInfo_th'];?></textarea><br></td>
						</tr>
					</table>
					<br><br>
					...
					<button type="submit" name="btn-submit" id="btn-submit" class="btn btn-dark">ลบข้อมูล</button>
				</center></form>
                </div>
            </div>
            </div>
